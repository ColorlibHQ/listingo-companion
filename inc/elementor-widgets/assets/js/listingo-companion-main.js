(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".listingo-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".listingo-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".listingo-team-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.listingo-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.listingo-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.listingo-subscribe-newsletter-area');
    if ($subscribe.length) {
