...
/**
 *
 * Listingo elementor Listingo categories section widget.
 *
 * @since 1.0
 */
class Listingo_Listing_Categories extends Widget_Base {

	public function get_name() {
		return 'listingo-listing-categories';
	}

	public function get_title() {
		return __( 'Popular Listing Cat.', 'listingo-companion' );
	}
	...
	protected function _register_controls() {
		...
		// ----------------------------------------  Listingo categories content ------------------------------
		$this->start_controls_section(
			'listingo_content',
			[
				'label' => __( 'Popular Listing Cat. content', 'listingo-companion' ),
			]
        );
        $this->add_control(
            'sub_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Discover', 'listingo-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default'   => esc_html__( 'Most Popular Categories', 'listingo-companion' ),
            ]
        );
        $this->add_control(
            'selected_cats',
            [
                'label' => esc_html__( 'Select Categories To Show', 'listingo-companion' ),
                'type' => Controls_Manager::SELECT2,
                'label_block' => true,
                'multiple' => true,
                'options'   => listingo_get_taxonomies(),
                // 'options'   => [
                //     '1' => 'eita',
                //     '2' => 'oita'
                // ],
		...
		$this->add_control(
			'cat_order',
			[
				'label'         => esc_html__( 'Category Order', 'listingo-companion' ),
		...
		$this->add_control(
			'cat_item',
			[
				'label'         => esc_html__( 'Item To Show', 'listingo-companion' ),
