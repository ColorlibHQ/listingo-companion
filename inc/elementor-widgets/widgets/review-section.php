...
/**
 *
 * Listingo Review Contents section widget.
 *
 * @since 1.0
 */
class Listingo_Review_Contents extends Widget_Base {

	public function get_name() {
		return 'listingo-review-contents';
	}

	public function get_title() {
		return __( 'Review Contents', 'listingo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'reviews_content',
			[
				'label' => __( 'Review Contents', 'listingo-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default' => esc_html__( 'Testimonial', 'listingo-companion' ),
            ]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'What our Client Says', 'listingo-companion' ),
            ]
        );
		...
		$this->add_control(
            'reviews', [
                ...
                'fields' => [
                    [
                        'name' => 'client_img',
                        'label' => __( 'Client Image', 'listingo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'review_txt',
                        'label' => __( 'Review Text', 'listingo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'reviewer_name',
                        'label' => __( 'Client Name', 'listingo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Adame Nesane', 'listingo-companion' ),
                    ],
                    [
                        'name' => 'reviewer_designation',
                        'label' => __( 'Client Designation', 'listingo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Chief Customer', 'listingo-companion' ),
                    ],
                ],
                'default'   => [
                    [
                        ...
                        'reviewer_name'         => __( 'Adame Nesane', 'listingo-companion' ),
                        'reviewer_designation'  => __( 'Chief Customer', 'listingo-companion' ),
                    ],
                    [
                        'client_img'         => [
                            'url' => Utils::get_placeholder_image_src()
        ...
        $this->start_controls_section(
            'style_title', [
                'label' => __( 'Style Review Section', 'listingo-companion' ),
        ...
        $this->add_control(
            'sec_overlay_col', [
                'label' => __( 'Section Overlay Color', 'listingo-companion' ),
    ...
    $quote_img = LISTINGO_DIR_ICON_IMG_URI . 'quote.svg';
    ?>
                    ...
                    <div class="testmonial_active owl-carousel">
                        ...
                        if( is_array( $reviews ) && count( $reviews ) > 0 ){
                            foreach ( $reviews as $review ) {
                                ...
                                $client_img = !empty( $review['client_img']['id'] ) ? wp_get_attachment_image( $review['client_img']['id'], 'listingo_widget_post_thumb', '', array( 'alt' => listingo_image_alt( $client_img_url ) ) ) : '';
                                ?>
