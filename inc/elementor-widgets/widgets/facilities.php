...
/**
 *
 * Listingo elementor facilities section widget.
 *
 * @since 1.0
 */
class Listingo_Facilities extends Widget_Base {

	public function get_name() {
		return 'listingo-facilities';
	}

	public function get_title() {
		return __( 'App Facilities', 'listingo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'facilities_content',
			[
				'label' => __( 'Facilities content', 'listingo-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default' => 'Save your time to <br>using listingo',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Facilities', 'listingo-companion' ),
		...
		$this->add_control(
            'facilities', [
                ...
                'fields' => [
                    [
                        'name' => 'item_icon',
                        'label' => __( 'Select Icon', 'listingo-companion' ),
                        'label_block' => true,
            ...
            <div class="row">
                ...
                if( is_array( $facilities ) && count( $facilities ) > 0 ) {
                    foreach( $facilities as $item ) {
                        $item_icon = ( !empty( $item['item_icon'] ) ) ? LISTINGO_DIR_ICON_IMG_URI . $item['item_icon'] : '';
