...
/**
 *
 * Listingo elementor business expert section widget.
 *
 * @since 1.0
 */
class Listingo_Business_Expert extends Widget_Base {

	public function get_name() {
		return 'listingo-business-expert';
	}

	public function get_title() {
		return __( 'Business Expert', 'listingo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Business Expert content', 'listingo-companion' ),
			]
        );
		$this->add_control(
            'tab_content', [
                ...
                'fields' => [
                    [
                        'name' => 'tab_title',
                        'label' => __( 'Tab Title', 'listingo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Excellent Services', 'listingo-companion' ),
                    ],
                    [
                        'name' => 'template_id',
                        'label' => __( 'Select Elementor Template', 'listingo-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [      
                        'tab_title' => __( 'Excellent Services', 'listingo-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Qualified Doctors', 'listingo-companion' ),
                    ],
                    [      
                        'tab_title' => __( 'Emergency Departments', 'listingo-companion' ),
                    ],
                ]
            ]
		);
    ...
    $this->start_controls_section(
        'style_room_section', [
            'label' => __( 'Style Business Expert Section', 'listingo-companion' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]
    );
    $this->add_control(
        'section_head_bg_col', [
            'label' => __( 'Section Head Bg Color', 'listingo-companion' ),
    ...
    $this->add_control(
        'tab_content_styles_separator', [
            'label' => __( 'Tab Content Styles', 'listingo-companion' ),
    ...
    $this->add_control(
        'icon_bg_col', [
            'label' => __( 'Icon Bg Color', 'listingo-companion' ),
            'type' => Controls_Manager::COLOR,
            'selectors' => [
