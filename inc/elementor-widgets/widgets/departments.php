...
/**
 *
 * Listingo elementor departments section widget.
 *
 * @since 1.0
 */
class Listingo_Departments extends Widget_Base {

	public function get_name() {
		return 'listingo-departments';
	}

	public function get_title() {
		return __( 'Departments', 'listingo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'departments_content',
			[
				'label' => __( 'Departments Section', 'listingo-companion' ),
			]
        );
        $this->add_control(
            'sec_title',
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Our Departments', 'listingo-companion' ),
            ]
        );
        $this->add_control(
            'sub_title',
		...
		$this->add_control(
            'departments', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Department Image', 'listingo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        'name' => 'item_title',
                        'label' => __( 'Department Title', 'listingo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Eye Care', 'listingo-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        'label' => __( 'Department Text', 'listingo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXTAREA,
                        'default' => __( 'Esteem spirit temper too say adieus who direct esteem.', 'listingo-companion' ),
                    ],
                    [
                        'name' => 'btn_text',
                        'label' => __( 'Button Text', 'listingo-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default' => __( 'Learn More', 'listingo-companion' ),
                    ],
                    [
                        'name' => 'btn_url',
                ...
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Eye Care', 'listingo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'listingo-companion' ),
                        'btn_text'   => __( 'Learn More', 'listingo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                        ],
                    ],
                    [      
                        ...
                        'item_title' => __( 'Physical Therapy', 'listingo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'listingo-companion' ),
                        'btn_text'   => __( 'Learn More', 'listingo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Dental Care', 'listingo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'listingo-companion' ),
                        'btn_text'   => __( 'Learn More', 'listingo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Diagnostic Test', 'listingo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'listingo-companion' ),
                        'btn_text'   => __( 'Learn More', 'listingo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Skin Surgery', 'listingo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'listingo-companion' ),
                        'btn_text'   => __( 'Learn More', 'listingo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
                    ...
                    [      
                        ...
                        'item_title' => __( 'Surgery Service', 'listingo-companion' ),
                        'item_text'  => __( 'Esteem spirit temper too say adieus who direct esteem.', 'listingo-companion' ),
                        'btn_text'   => __( 'Learn More', 'listingo-companion' ),
                        'btn_url'    => [
                            'url' => '#'
     ...
     */
        ...
        $this->add_control(
            'sec_bg_col', [
                'label' => __( 'Section Bg Color', 'listingo-companion' ),
        ...
        $this->add_control(
            'big_title_col', [
                'label' => __( 'Big Title Color', 'listingo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'title_hover_col', [
                'label' => __( 'Title Hover Color', 'listingo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'text_col', [
                'label' => __( 'Text Color', 'listingo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'anchor_text_col', [
                'label' => __( 'Anchor Text Color', 'listingo-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
            ...
            <div class="row">
                ...
                if( is_array( $departments ) && count( $departments ) > 0 ) {
                    foreach( $departments as $department ) {
                        ...
                        $item_img = !empty( $department['item_img']['id'] ) ? wp_get_attachment_image( $department['item_img']['id'], 'listingo_department_thumb_362x240', '', array('alt' => $item_title . ' image' ) ) : '';
