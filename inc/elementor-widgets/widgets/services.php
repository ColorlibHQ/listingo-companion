...
/**
 *
 * Listingo elementor service section widget.
 *
 * @since 1.0
 */
class Listingo_Services extends Widget_Base {

	public function get_name() {
		return 'listingo-service';
	}

	public function get_title() {
		return __( 'Services', 'listingo-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'service_content',
			[
				'label' => __( 'Services content', 'listingo-companion' ),
			]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Services', 'listingo-companion' ),
		...
		$this->add_control(
            'services', [
                ...
                'fields' => [
                    [
                        'name' => 'item_img',
                        'label' => __( 'Upload Image', 'listingo-companion' ),
                        'label_block' => true,
                    ...
                    [
                        ...
                        'default'     => __( 'Birthday Catering', 'listingo-companion' ),
                    ],
                    [
                        'name' => 'item_text',
                        ...
                        'default'     => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'listingo-companion' ),
                    ],
                ],
                'default'   => [
                    [      
                        ...
                        'item_title' => __( 'Birthday Catering', 'listingo-companion' ),
                        'item_text'  => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'listingo-companion' ),
                    ],
                    [      
                        'item_img'  => [
                            'url'   => Utils::get_placeholder_image_src(),
                        ],
                        'item_title' => __( 'Party Catering', 'listingo-companion' ),
                        'item_text'  => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'listingo-companion' ),
                    ],
                    [      
                        'item_img'  => [
                        ...
                        'item_title' => __( 'Wedding Catering', 'listingo-companion' ),
                        'item_text'  => __( 'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'listingo-companion' ),
                    ],
                ]
            ]
                    ...
                    <div class="dish_wrap d-flex">
                        ...
                        if( is_array( $services ) && count( $services ) > 0 ) {
                            foreach( $services as $item ) {
                                ...
                                $item_img  = !empty( $item['item_img']['id'] ) ? wp_get_attachment_image( $item['item_img']['id'], 'listingo_dish_thumb_192x192', '', array( 'alt' => $item_title ) ) : '';
