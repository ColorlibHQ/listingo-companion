...
/**
 *
 * Listingo elementor call to action section section widget.
 *
 * @since 1.0
 */
class Listingo_Call_To_Action extends Widget_Base {

	public function get_name() {
		return 'listingo-call-to-action';
	}

	public function get_title() {
		return __( 'Call To Action', 'listingo-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Call To Action Section', 'listingo-companion' ),
            ]
        );
        $this->add_control(
            'bg_img',
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Sec Title', 'listingo-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Sprayed Your Business with Us', 'listingo-companion' ),
            ]
        );  
        $this->add_control(
            'sub_title',
        ...
        $this->add_control(
            'btn_label',
            [
                'label' => esc_html__( 'Button Label', 'listingo-companion' ),
                'type' => Controls_Manager::TEXT,
                'label_block' => true,
                'default' => esc_html__( 'Add Your Business', 'listingo-companion' ),
            ]
        );
        $this->add_control(
            'btn_url',
        ...
        $this->start_controls_section(
            'left_sec_style', [
                'label' => __( 'Top Section Styles', 'listingo-companion' ),
        ...
        $this->add_control(
			'button_hover_col', [
				'label' => __( 'Button Hover Bg Color', 'listingo-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Overlay Color Styles', 'listingo-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
			'sec_title_col', [
				'label' => __( 'Bg Overlay Color', 'listingo-companion' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
    ...
    <!-- sprayed_area  -->
    <div class="sprayed_area overlay" <?php echo listingo_inline_bg_img( esc_url( $bg_img ) ); ?>>
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
