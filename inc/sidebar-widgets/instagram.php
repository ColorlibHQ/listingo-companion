...
----------------------------------------*/
class listingo_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('listingo_instagram_photo',esc_html__('[ Listingo ] Intagram Photo','listingo-companion'),array(
			'description' => esc_html__('Listingo Instagram Photo Widget','listingo-companion'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'listingo-companion');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'listingo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'listingo-companion'); ?></label>
...
if(!function_exists('listingo_instagram_widgets')):
	function listingo_instagram_widgets(){
		register_widget('listingo_instagram_photo');
	}
	add_action('widgets_init','listingo_instagram_widgets');
endif;
