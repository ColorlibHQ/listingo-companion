...
class Listingo_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        'listingo_social_links',


        // Widget name will appear in UI
        esc_html__( '[ Listingo ] Social Links', 'listingo-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'listingo-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'listingo-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'listingo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'listingo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'listingo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'listingo-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'listingo-companion'); ?></label>
...
} // Class listingo_social_links ends here


// Register and load the widget
function listingo_social_links_widget_load() {
	register_widget( 'Listingo_social_links' );
}
add_action( 'widgets_init', 'listingo_social_links_widget_load' );